...
export function getBlog () {
  return axios.get('https://greg-fbia.firebaseio.com/blog-data/articles.json?orderBy="$key"&limitToLast=15')
  .then((response) => {
    store.blogStore = {
      ...store.blogStore,
      ...response.data
...
export function getOneBlog ({ articleID }) {
  return axios.get('https://greg-fbia.firebaseio.com/blog-data/articles/' + articleID + '.json')
  .then((response) => {
    store.blogStore = {
      ...store.blogStore,
      [articleID]: {
